...
var _lamps = __webpack_require__(367);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

// import { LampsBtn } from './components/lamps/lamps.js';

var firstLamps = new _lamps.Lamps(document.querySelector('#lamps1'));
// const firstButtons = new LampsBtn(document.querySelector('#lamps1'));

var LampsManager = function LampsManager(button, arrayOfLamps) {
    var _this = this;
    ...
    this.button.addEventListener('click', function () {
        if (_this.lampsArr[0].isEnabled === true) {
            _this.lampsArr[0].switchOffLamp();
        } else {
            _this.lampsArr[0].switchOnAllLamp();
        }
        console.log(_this.lampsArr[0].isEnabled);
    });
};

var u = new LampsManager(document.querySelector('#toggle_all'), [firstLamps]);
...
var LAMP_CLASS_NAME = 'lamps__lamp';
var LAMP_ACTIVE_CLASS_NAME = 'lamps__lamp_active';

var Lamps = function () {
    function Lamps(targetElement) {
    ...
    _createClass(Lamps, [{
        ...
        key: 'switchOnAllLamp',
        value: function switchOnAllLamp() {
            var _this2 = this;
        ...
        key: 'switchOnLamp',
        value: function switchOnLamp(element) {
            console.log('ENABLED');
